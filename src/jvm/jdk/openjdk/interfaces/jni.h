...
struct JNINativeInterface_
{
    ...
    void (JNICALL *SetBooleanArrayRegion)(JNIEnv *env, jbooleanArray array,
        jsize start, jsize l, const jboolean *buf);
...
struct JNIEnv_
{
      ...
      ...)
    {
      ...
      jbyte result;
      va_start(args, methodID);
      result = functions->CallNonvirtualByteMethodV(this, obj, clazz, methodID,
        args);
      va_end(args);
      return result;
    }
      ...
      ...)
    {
      ...
      jchar result;
      va_start(args, methodID);
      result = functions->CallNonvirtualCharMethodV(this, obj, clazz, methodID,
        args);
      va_end(args);
      return result;
    }
      ...
      jmethodID methodID, ...)
    {
      ...
      jshort result;
      va_start(args, methodID);
      result = functions->CallNonvirtualShortMethodV(this, obj, clazz, methodID,
        args);
      va_end(args);
      return result;
    }
      ...
      ...)
    {
      ...
      jint result;
      va_start(args, methodID);
      result = functions->CallNonvirtualIntMethodV(this, obj, clazz, methodID,
        args);
      va_end(args);
      return result;
    }
      ...
      ...)
    {
      ...
      jlong result;
      va_start(args, methodID);
      result = functions->CallNonvirtualLongMethodV(this, obj, clazz, methodID,
        args);
      va_end(args);
      return result;
    }
      ...
      jmethodID methodID, ...)
    {
      ...
      jfloat result;
      va_start(args, methodID);
      result = functions->CallNonvirtualFloatMethodV(this, obj, clazz, methodID,
        args);
      va_end(args);
      return result;
    }
